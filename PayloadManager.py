...
class Payload:
    ...
    def hit(self, url):
        ...
        try:
            ...
            # Validate creds, headers, and cookies before using them
            if self.creds is not None:
                response = self.cred(url)
            elif self.headers and isinstance(self.headers, dict) and self.cookies and isinstance(self.cookies, dict):
            ...
            elif self.cookies and isinstance(self.cookies, dict):
